        ...
        <div className="flex flex-col items-center gap-5 pb-3 pt-9 sm:flex-row-reverse sm:justify-between sm:pb-4 sm:pt-11">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.04] text-bluelagoon-snow/60 ring-1 ring-inset ring-white/[0.08] transition hover:bg-white/[0.08] hover:text-bluelagoon-snow"
            >
          ...
          <p className="text-center text-[11px] text-bluelagoon-snow/50 sm:text-left">
